...
const Chat = () => {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className='flex h-screen max-h-screen py-5 px-28 bg-gray-200 dark:bg-gray-600'>

        {/* Sidebar */}
        <aside className='w-1/6 bg-white dark:bg-slate-950 flex flex-col justify-between rounded-lg p-3'>
          <div className='flex justify-center py-4'>
            <BsFillSunFill className='w-6 h-6 text-yellow-600' />
            {darkMode
              ? (
                <BsLayoutTextSidebar
            ...
            <BsFillMoonStarsFill className='w-6 h-6 text-blue-900' />
          </div>
        ...
        <div className='flex flex-col flex-1 px-3'>
          ...
          {/* Top Bar */}
          <div className='bg-gray-200 dark:bg-gray-600 h-12 mb-4 flex justify-end items-center'>
          ...
          <div className='flex-1 bg-gray-200 dark:bg-gray-600 overflow-y-auto mb-4'>
          ...
          <footer className='relative'>
            <form onSubmit={handleSubmit}>
              <textarea
              // ref={textareaRef}
                className='w-full border-none font-[16px] bg-white dark:bg-slate-950 py-2 px-3 shadow-lg text-black dark:text-gray-300 outline-none rounded-lg'
                // className='textarea'
                value={value}
